...
public class RackCharacter
{
	...
	public Vector3 penisTip(bool afterIK = false)
	{
		...
		Vector3 lossyScale = this.bones.Penis4.lossyScale;
		return position - a * lossyScale.x;
	}
	...
	public void processBelly()
	{
		...
		this.setBodyBlend("Belly", this.cap(this.belly_act + this.inflationAmount, 0f, 1f) * 100f);
	}
